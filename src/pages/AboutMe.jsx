// src/pages/AboutMe.jsx (CORRIGIDO com FOTO e ORDENAÇÃO MOBILE)
...
<div className="max-w-6xl mx-auto">
 ...
 {/* Bloco de Introdução e Imagem/Avatar (Container Pai) */}
 <div className="flex flex-col md:flex-row gap-10 mb-16 items-center">
 
    {/* 1. CONTAINER DA IMAGEM (NOVO: order-1 no mobile para ficar no topo) */}
    <div className="md:w-1/3 flex justify-center order-1 md:order-2">
   <img 
      src="/foto-perfil-temporario.png" 
      alt="Roberto Mazor - Desenvolvedor Full-Stack"
      className="w-60 h-60 object-cover rounded-full border-4 border-teal-500 shadow-xl transition duration-300 hover:shadow-cyan-500/50"
   />
  </div>
 
   {/* 2. CONTAINER DO TEXTO (NOVO: order-2 no mobile para ficar abaixo da foto) */}
